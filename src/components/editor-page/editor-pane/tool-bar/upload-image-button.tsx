...
export const UploadImageButton: React.FC<UploadImageButtonProps> = ({ editor }) => {
  ...
  return (
    <Fragment>
      <Button variant='light' onClick={buttonClick} title={t('editor.editorToolbar.uploadImage')} {...cypressId('editor-toolbar-upload-image-button')}>
        <ForkAwesomeIcon icon={'upload'} />
      </Button>
      <UploadInput onLoad={onUploadImage} acceptedFiles={acceptedMimeTypes} onClickRef={clickRef} {...cypressId('editor-toolbar-upload-image-input')} />
    </Fragment>
  )
}
